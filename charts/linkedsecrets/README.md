...
``` bash
kubectl delete -f https://github.com/kubeideas/linkedsecrets/releases/download/v0.6.0/security.kubeideas.io_linkedsecrets.yaml
```
...
Create AWS user with permissions to read secrets and generate an Access key.
